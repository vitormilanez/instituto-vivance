...
const paths = {
  ...
  wifiOff: ["M2 2l20 20", "M8.5 16.5a5 5 0 0 1 7 0", "M5 12.9a10 10 0 0 1 5.2-2.8", "M19 12.9a10 10 0 0 0-2.3-1.6", "M2 8.8a15 15 0 0 1 4.2-2.8", "M22 8.8A15 15 0 0 0 10.7 5.1", "M12 20h.01"],
