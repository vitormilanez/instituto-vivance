...
export const patientSections = [
  ...
  { slug: "receitas", title: "Receitas anteriores", group: "cuidado", description: "Suas receitas em arquivo ou link da Memed, reunidas para consulta." },
  ...
  // aparecem na navegação: têm começo, fim e um "voltar".
  {
    ...
    title: "Boas-vindas",
    group: "acao",
    description: "O combinado do seu acompanhamento.",
  },
  {
    slug: "lembretes",
    title: "Lembretes",
    group: "acao",
    description: "Quando lembrar você do check-in.",
  },
  {
    slug: "preconsulta",
    title: "Pré-consulta",
