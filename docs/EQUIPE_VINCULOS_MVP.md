...
- Arquivos de migração `20260911043121_team_and_care_relationships` e `20260911044758_care_reassignment_requires_active_member` alinhados ao histórico do Supabase de desenvolvimento. A Edge Function `invite-staff` está ativa na versão 2, com validação JWT. Chamada sem sessão retornou 401 sem criar identidade ou vínculo.
