...
- Conexão com GitHub pendente: Vercel retornou `You need to add a Login Connection to your GitHub account first`.
...
- Autorizar GitHub nas conexões pessoais da conta Vercel da VTR Consulting.
