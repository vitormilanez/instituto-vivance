...
- Referência executável: `docs/ONBOARDING_MVP.md` no checkout `instituto-vivance-onboarding`. Estado desta atualização: implementação iniciada; nenhuma publicação ou migração remota confirmada.
...
- Código mais recente também lido em `instituto-vivance-slice-7b2`, `7b49597`. Sua diferença para `6613e45` é a correção de retorno de convite da PR #15, ainda aberta no momento da consulta; não tratá-la como integrada.
...
| --- | --- | --- | --- |
| Acesso e equipe | Perfis e entrada em cada área | Sessão, clínica, papéis, contas, convites e vínculos | Fechar o retorno do convite da PR #15 e comprovar primeiro acesso de conta nova no ambiente correto |
...
- Partir da branch que contém `6613e45`, preservando as alterações locais e a PR #15 separada até a revisão.
